    ...
    function updateStatusBox(isChecked) {
        ...
        if (isChecked) {
            ...
            statusBox.innerHTML = isMobile
                ? `<span class="line"><span class="highlight"> Wiki Info Mode:</span> Gives fast, clear summaries</span><br>
                ...
                : `<span class="line"><span class="highlight">Wiki Info Mode:</span> Gives fast, clear summaries for well-known books. But</span><br>
            ...
            statusBox.innerHTML = isMobile
                ? `<span class="line"><span class="highlight">AI Info Mode:</span> Slower, yet precise and</span><br>
                <span class="line">in-depth. Ideal for infamous books, deep insights</span><br>
                <span class="line">and comprehensive coverage.</span>`
                : `<span class="line"><span class="highlight">AI Info Mode:</span> Slower, yet precise and in-depth. Ideal for infamous books     </span><br>
                <span class="line">deep insights and comprehensive coverage.</span>`;
